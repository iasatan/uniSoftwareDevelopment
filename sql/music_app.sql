use music_app;
create table user(uid int primary key auto_increment, name varchar(100) not null, role int default 0, email varchar(50) not null, password varchar(100) not null, gender enum('m','f', 'o') not null, address varchar(100), typeOfResidence enum('flat', 'detached house', 'cottage', 'mansion','dormitory'));
...
insert  into user (name, email, password, gender, address, typeOfResidence) values ('Antal', 'fekete20@iit.uni-miskolc.hu', 'sdfhghjfsds', 'm', 'Miskolc', 'flat');
